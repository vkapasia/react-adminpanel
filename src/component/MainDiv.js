            ...
            <Col xs={12} lg={12} className="border topBox mt-lg-2 mb-5">
              ...
              <div className='blur shadow p-3 mb-5 innerbox d-flex align-items-center justify-content-between'>
                ...
                <div className='d-sm-flex align-items-center justify-content-between'>
                  <button className='bg-white btn d-flex align-items-center justify-content-between'> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-google-play" viewBox="0 0 16 16">
                    <path d="M14.222 9.374c1.037-.61 1.037-2.137 0-2.748L11.528 5.04 8.32 8l3.207 2.96zm-3.595 2.116L7.583 8.68 1.03 14.73c.201 1.029 1.36 1.61 2.303 1.055zM1 13.396V2.603L6.846 8zM1.03 1.27l6.553 6.05 3.044-2.81L3.333.215C2.39-.341 1.231.24 1.03 1.27" />
                  </svg><span className='ms-2 d-none d-md-block'>App</span></button>
                  <button className='btn d-flex align-items-center justify-content-between'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-envelope-at" viewBox="0 0 16 16">
                  ...
                  </svg><span className='ms-2 d-none d-md-block'>Message</span></button>
                  <button className='btn d-flex align-items-center justify-content-between'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-gear-wide-connected" viewBox="0 0 16 16">
                  ...
                  </svg><span className='ms-2 d-none d-md-block'>Setting</span></button>
                </div>
              </div>
            </Col>
          </Row>
